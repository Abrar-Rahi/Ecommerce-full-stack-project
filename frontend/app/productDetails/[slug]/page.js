...
const ProductDatails = async ({ params }) => {
  ...
  return (
    <Container>
      <Row style={{ paddingTop: '100px', paddingBottom: '100px' }}>
        {data.map(item => (
          <>
            <Col style={{ marginLeft: '170px', width:'50%' }}>
            ...
            <Col style={{ marginTop: '100px' }}>
              ...
              <div style={{ display: 'flex', gap: '20px', marginBottom: '10px' }}>
                ...
                <div style={{ backgroundColor: '#F5F5FC', display: 'inline-block', borderRadius: '20px', paddingTop: '5px', paddingRight: '10px', paddingLeft: '10px' }}>
                  <p style={{ marginTop: '5px' }}>Price: <span style={{ fontWeight: '600' }}>{item.sellPrice ? item.sellPrice : item.productPrice}৳</span> </p>
                </div>
